function [ImageMask,th,bg]=ThreshImage_ultrasen(ImageOld)
...
%% get threshold
TempSeries3=TempSeries((TempSeries>(bg-gp*tbin))&(TempSeries<(xout(Ibg00(I_DD+1))+gp*tbin)));
[n_th,xout_th]=ksdensity(TempSeries3,bg:(xout(Ibg00(I_DD+1))-bg)/100:xout(Ibg00(I_DD+1)));
