function [risetime,badtraces]=getCdk2rise_3(sampletraces,samplestats,minlength,Drugoption,quiescentanalysis,maxFrame)
...
for i=1:samplesize
    ...
    if ~isempty(maxFrame)
        if samplestats(i,2)>maxFrame
            lastframe(i)=maxFrame;
        else
            lastframe(i)=samplestats(i,2);
        end
    end
