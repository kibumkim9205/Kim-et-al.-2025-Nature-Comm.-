function histogram_3D_v3(yvalues,bmin,bmax,num_bins,offset_increment,color1,color2,xlims,mthd)
...
[histogram_of_data]=histogram(yvalues{condition},num_bins,'Normalization','probability','BinLimits',[bmin,bmax]);
percent_total(condition,:)=histogram_of_data.Values;
end
...
new_yvalues=[column_of_zeros, percent_total(:,xlim1:xlim2), column_of_zeros, column_of_zeros]; %Addes zeros to the beginning and end of the yvalues to make them a closed shape
