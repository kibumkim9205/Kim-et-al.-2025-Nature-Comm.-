...
ci = 1+ceil((l-1)*a/max(a(:))); %This line and the previous were edited by Sean Collins on 7-16-2013 so that zero values appear with the correct color in the final image
ci = min(ci,l); %This line was added by Sean Collins on 7-16-2013
