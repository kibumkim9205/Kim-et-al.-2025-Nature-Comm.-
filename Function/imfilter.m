...
if (kernelIsReal && imageIsReal)
  ...
  result = images.internal.builtins.imfilter(a, outSize, h, nonzero_h,...
                        conn, start, sameSize, convMode, ippFlag);

elseif (kernelIsReal && ~imageIsReal)

  realB = images.internal.builtins.imfilter(real(a), outSize, h, nonzero_h,...
                    conn, start, sameSize, convMode, ippFlag);

  imagB = images.internal.builtins.imfilter(imag(a), outSize, h, nonzero_h, ...
                    conn, start, sameSize, convMode, ippFlag);
...
elseif (~kernelIsReal && imageIsReal)
  ...
  realB = images.internal.builtins.imfilter(a, outSize, real(h), real(nonzero_h),...
                    conn, start, sameSize, convMode, ippFlag);

  imagB = images.internal.builtins.imfilter(a, outSize, imag(h), imag(nonzero_h), ...
                    conn, start, sameSize, convMode, ippFlag);
  ...
  realHrealA = images.internal.builtins.imfilter(real(a), outSize, real(h), real(nonzero_h),...
                    conn, start, sameSize, convMode, ippFlag);
  realHimagA = images.internal.builtins.imfilter(imag(a), outSize, real(h), real(nonzero_h),...
                    conn, start, sameSize, convMode, ippFlag);
  imagHrealA = images.internal.builtins.imfilter(real(a), outSize, imag(h), imag(nonzero_h),...
                    conn, start, sameSize, convMode, ippFlag);
  imagHimagA = images.internal.builtins.imfilter(imag(a), outSize, imag(h), imag(nonzero_h), ...
                    conn, start, sameSize, convMode, ippFlag);
