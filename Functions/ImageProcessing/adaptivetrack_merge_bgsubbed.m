function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_merge(lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,nucr,jitter,H2BvsNLS)
