...
ringedgeouter=imdilate(nuc_label,strel('disk',ringwidth,0));  %Calc w/ thicken correctly!
ringedgeinner=imdilate(nuc_label,strel('disk',2,0));          %Calc with thicken correctly!
cytoring=ringedgeouter-ringedgeinner;                         %define cytoring with label ID
