function mask=bridgedeflections(mask,nucr)
...
for ci=1:obnum
    ...
    bordermask=splitdeflections_5(orderedset,bordermask,nucr);
end
mask=mask & ~bordermask;
mask=~bwmorph(~mask,'diag');
end

function [bordermask,bridgeflag]=splitdeflections_5(orderedset,bordermask,nucr)
