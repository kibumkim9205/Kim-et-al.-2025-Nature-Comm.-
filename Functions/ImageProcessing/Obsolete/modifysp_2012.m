function [newsp,trk_rc]=modifysp(wellsp)

removemerges = 1;           %0: keep merge events. 1: remove merge events
...
%% remove single spots
lo=(trk_rc(:,1)==trk_rc(:,3));          %'lo' stands for 'leave out'?
orphanlo(lo)=1;
