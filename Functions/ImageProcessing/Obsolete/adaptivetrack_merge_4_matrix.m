function [tracedata,curdatafinal,tracking,nuc_label]=adaptivetrack_merge(lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,nucr,jitter)
...
numprevorg=find(tracedata(:,lastgoodframe,1),1,'last');
xprev=tracedata(1:numprevorg,lastgoodframe,1); yprev=tracedata(1:numprevorg,lastgoodframe,2); massprev=tracedata(1:numprevorg,lastgoodframe,4);
