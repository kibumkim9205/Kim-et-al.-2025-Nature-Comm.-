function [tracked,newdaughters,nuc_label]=adaptivetrack_abs_area(prevdata,curdata,nuc_raw,nuc_label,nucr,jitter,extractmask,reljitx,reljity)
...
for i=1:numprev
    ...
    consistencycheck=abs(massdiff)<0.20;
...
dbimage(:,:,2)=dbmaskcur;
dbimage(:,:,3)=0;
figure,imshow(imresize(dbimage,4));
%}