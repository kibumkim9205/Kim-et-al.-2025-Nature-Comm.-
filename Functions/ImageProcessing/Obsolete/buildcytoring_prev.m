...
N_exm=detectoverlaps(N_home,N_out,1,cytoringoutermass,legitedges,REs_bs,height);
NW_exm=detectoverlaps(NW_home,NW_out,1,cytoringoutermass,legitedges,REs_bs,height);
W_exm=detectoverlaps(W_home,W_out,1,cytoringoutermass,legitedges,REs_bs,height);
SW_exm=detectoverlaps(SW_home,SW_out,1,cytoringoutermass,legitedges,REs_bs,height);
S_exm=detectoverlaps(S_home,S_out,-1,cytoringoutermass,legitedges,REs_bs,height);
SE_exm=detectoverlaps(SE_home,SE_out,-1,cytoringoutermass,legitedges,REs_bs,height);
E_exm=detectoverlaps(E_home,E_out,-1,cytoringoutermass,legitedges,REs_bs,height);
NE_exm=detectoverlaps(NE_home,NE_out,-1,cytoringoutermass,legitedges,REs_bs,height);
