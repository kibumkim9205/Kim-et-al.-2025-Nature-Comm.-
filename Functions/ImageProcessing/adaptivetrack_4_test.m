function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_2(lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,nucr,jitter,H2BvsNLS,debugpackage)
...
previdx=3767;
%prevcellandcurrentneighbors(debugpackage,nuc_mask,winrad,xprev,yprev,previdx);
prevcellandcurrentneighbors(debugpackage,nuc_label,winrad,xprev,yprev,previdx);
%}