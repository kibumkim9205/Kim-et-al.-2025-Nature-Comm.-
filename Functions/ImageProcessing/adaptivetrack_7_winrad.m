function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_6(lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,nucr,jitter,winrad,H2BvsNLS,debugpackage)
