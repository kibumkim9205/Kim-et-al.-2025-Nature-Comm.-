function [bordermask,bridgeflag]=splitdeflections_4(orderedset,bordermask,nucr)
...
while vnum>=2
    ...
    %%% If there are 3 or less vertices, remove 1 vertex and make sure that
    %%% both remaining perimeters are longer than some threshold.
    if vnum<=3
        if vnum==3
