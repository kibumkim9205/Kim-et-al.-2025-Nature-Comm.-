function [ImageMask,th,bg]=ThreshImage_Compression(ImageOrg,compression)
ImageComp=imresize(ImageOrg,1/compression,'nearest');

TempSeries=ImageComp(:);
