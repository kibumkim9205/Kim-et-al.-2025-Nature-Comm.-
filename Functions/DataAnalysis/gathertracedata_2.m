function [tracedata,tracestats,motherstats,IFdata]=gathertracedata_2(datadir,shot,motheroption,daughteroption,IFoption,numframes)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% append NaN frames to have numframes %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
maxframes=size(tracedata,2);
if numframes>maxframes
    padnum=numframes-maxframes;
    numrows=size(tracedata,1); numchannels=size(tracedata,3);
    nandata=ones(numrows,padnum,numchannels)*NaN;
    tracedata=[tracedata nandata];
end
%%% gate by genealogy %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
