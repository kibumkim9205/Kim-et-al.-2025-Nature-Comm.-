...
switch maxpos
    ...
    case 1
        for i=1:numtraces
            ...
            %minmotherlength=3;
            %motherdelay=min([minmotherlength motherstats(i,3)]);
            %toolow(i)=max(signals(i,motherstats(i,2)-motherdelay:motherstats(i,2)))<maxthreshold;
            toolow(i)=max(signals(i,motherstats(i,2)))<maxthreshold;
        end
    case 2
        for i=1:numtraces
