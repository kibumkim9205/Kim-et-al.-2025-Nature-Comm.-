function [tracesCdk2,badtracesCdk2]=gate_Cdk2_4(tracedata,nucchannel,cytochannel,tracestats,maxoption,maxthresh,noisethresh,quiescentanalysis)
...
%%% gate CDK2 data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
badtracesCdk2=gate_Cdk2_noisecalcdiff1_5(tracesCdk2gating,tracesCdk2,tracestats,maxoption,maxthresh,noisethresh,quiescentanalysis); %noisethresh=0.15
