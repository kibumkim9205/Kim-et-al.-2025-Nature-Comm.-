function [time,datatotal]=aligntraces(alltraces,allstats,allmotherstats,alignoption,drugspike,mitosisoption,motherperc,daughterperc,framesperhr)
...
elseif alignoption==2
    ...
    for i=1:numtraces
        if mitosisoption && historyoption
