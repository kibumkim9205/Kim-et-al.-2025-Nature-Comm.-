function [tracesCdk2,badtracesCdk2]=gate_Cdk2_3(tracedata,nucchannel,cytochannel,tracestats,durationrange,maxthresh,noisethresh,quiescentanalysis)
...
%%% gate CDK2 data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
badtracesCdk2=gate_Cdk2_noisecalcdiff_durationwindow(tracesCdk2gating,tracesCdk2,tracestats,durationrange,maxthresh,noisethresh,quiescentanalysis); %noisethresh=0.15
