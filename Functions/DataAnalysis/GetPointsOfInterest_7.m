function [POI,badtraces]=GetPointsOfInterest_2(signal,traces,stats,minlength,risethresh)
switch signal
    case 'Cdk2_R'
        getCdk2features_R_serumrelease_2(traces,stats);
    case 'Cdk2_G1'
    ...
    case 'Geminin_SR'
        ...
        [POI,badtraces]=getGemininfeatures_serumrelease_abs(traces,stats,risethresh); %abs
    case 'Geminin_SR_2'
        [POI,badtraces]=getGemininfeatures_serumrelease_abs_2(traces,stats,risethresh); %abs
    case 'PipdegFall'
