function [tracesCdk2,badtracesCdk2]=gate_Cdk2_4(tracedata,nucchannel,cytochannel,tracestats,minlength,maxthresh,noisethresh,quiescentanalysis)
...
%%% gate CDK2 data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
badtracesCdk2=gate_Cdk2_noisecalcdiff1_3(tracesCdk2gating,tracesCdk2,tracestats,minlength,maxthresh,noisethresh,quiescentanalysis); %noisethresh=0.15
