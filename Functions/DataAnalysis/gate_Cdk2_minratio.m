function badtraces=gate_Cdk2(DHBnuc,DHBratio,tracestats,maxoption,threshold,noisethresh,quiescentanalysis,firstratio,minratio)
...
if quiescentanalysis
    ...
    notquiescent=mean(DHBratio(:,1:3),2)>firstratio | tracestats(:,1)>1 | min(DHBratio,[],2)>minratio; %only accept cells that are present from beginning and <1.0 ratio
