...
for i=1:samplesize
    ...
    for j=1:numframes-futurebuffer
        ...
        %bufferfutureheight=signal(j+postbuffer)>signal(j)+0.25*risethresh; %org
        bufferfutureheight=signal(j+postbuffer)>signal(j)+50;
    ...
    filterscore=sig_fwdslope-signal+sig_time+1000;
