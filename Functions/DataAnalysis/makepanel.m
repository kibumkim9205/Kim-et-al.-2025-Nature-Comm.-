function makepanel(coor,rawimg,mask,maxnum,tileradius,satperc)
...
sathigh=double(round(prctile(rawimg(:),satperc(2))));
satlow=double(round(prctile(rawimg(:),satperc(1))));
